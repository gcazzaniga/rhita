...
import rhita.hazards_detection_v1 as hd
import rhita.output_options_v1 as oo
...
def main(ds, ds_th, config):
    ...
    if config['methods_parameters']['threshold1'] == 'map':
        var_th = ds_th[config['data_structure']['variable_name']].values
        ds_th.close()
